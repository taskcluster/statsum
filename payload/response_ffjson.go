...
const (
	...
	ffj_t_Response_Message
)

var ffj_key_Response_Code = []byte("code")

var ffj_key_Response_Message = []byte("message")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'c':
					...
					if bytes.Equal(ffj_key_Response_Code, kn) {
						currentKey = ffj_t_Response_Code
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'm':
					...
					if bytes.Equal(ffj_key_Response_Message, kn) {
						currentKey = ffj_t_Response_Message
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffj_key_Response_Message, kn) {
					currentKey = ffj_t_Response_Message
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffj_key_Response_Code, kn) {
					currentKey = ffj_t_Response_Code
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffj_t_Response_Code:
					goto handle_Code

				case ffj_t_Response_Message:
					goto handle_Message
